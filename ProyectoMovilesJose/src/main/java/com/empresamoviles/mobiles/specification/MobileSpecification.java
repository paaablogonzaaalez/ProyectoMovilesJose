 ...
 * Permite combinar filtros opcionales de forma limpia y extensible.
 */
public class MobileSpecification {

    /**
     * Genera una Specification combinada a partir del DTO de criterios.
     * priceMin y priceMax son obligatorios y siempre se aplican.
     * El resto de filtros solo se aplican si no son nulos.
     *
