...
public class MobileCreateDTO {
	   ...
	   @NotBlank(message = "La marca es obligatoria")
	    ...
	    @NotNull(message = "El numero de nucleos es obligatorio")
	    @Min(value = 1, message = "El minimo de núcleos es 1")
	    @Max(value = 32, message = "El maximo de núcleos es 32")
	    private Integer processorCores;

	    @NotNull(message = "La velocidad maxima del procesador es obligatoria")
	    ...
	    @NotNull(message = "Debes indicar si el movil tiene NFC")
	    private Boolean nfc;
